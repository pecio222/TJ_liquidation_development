...
contract FlashloanBorrowerDev is ERC3156FlashBorrowerInterface, Ownable {
    ...
    function doFlashloan (
        ...
        ERC3156FlashLenderInterface(joinedAddresses[0]).flashLoan(this, address(this), flashBorrowAmount[0], data);
    }
    ...
    function onFlashLoan(
        ...
        if (liquidation == 0)
        {
            ...
            JErc20Interface(joinedAddresses[4]).redeem(earnedJToken);
            ...
            wavaxAddress, earnedSizedToken, amount_avax);
        }
